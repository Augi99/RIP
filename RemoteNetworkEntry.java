...
public class RemoteNetworkEntry extends Entry{
    ...
    public void writeEntry()
    {
        if(!getSubnetted())
        {
            System.out.println(getRouteSource() + "       " + getDestinationNetwork().getAddress() + "/" + getSubnetMask() + "  [" + getAdministrativeDistance() + "/" + getMetric() + "]  via  " + getNextHop().getAddress() + ",  " + getRouteTimestamp() + "  " + getOutgoingInterface());

        }else System.out.println(getRouteSource() + "         " + getDestinationNetwork().getAddress() + "/" + getSubnetMask() + "  [" + getAdministrativeDistance() + "/" + getMetric() + "]  via  " + getNextHop().getAddress() + ",  " + getRouteTimestamp() + "  " + getOutgoingInterface());
    }
